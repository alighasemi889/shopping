  ...
  registerForm.addEventListener("submit", function (e) {
    ...
    if (password !== confirmPassword) {
      ...
      errorMessage.innerHTML =
        '<i class="fa-solid fa-exclamation-circle"></i> رمز عبور و تکرار آن مطابقت ندارند!';
    ...
    submitButton.innerHTML =
      '<span class="flex items-center justify-center"><i class="fa-solid fa-spinner fa-spin mr-2"></i> در حال ثبت نام...</span>';
    ...
    setTimeout(() => {
      ...
      successMessage.innerHTML =
        '<i class="fa-solid fa-check-circle"></i> ثبت نام با موفقیت انجام شد! در حال انتقال...';
