document.addEventListener('DOMContentLoaded', function () {
    ...
    emailInput.addEventListener('input', function () {
        ...
        } else if (!emailPattern.test(emailValue) && !usernamePattern.test(emailValue)) {
    ...
    loginForm.addEventListener('submit', function (e) {
        ...
        setTimeout(() => {
            ...
            successMessage.className = 'success-message text-green-500 text-sm mt-2 flex items-center';
            successMessage.innerHTML = '<i class="fa-solid fa-check-circle mr-2"></i> ورود با موفقیت انجام شد! در حال انتقال...';
